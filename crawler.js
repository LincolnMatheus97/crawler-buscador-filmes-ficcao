...
export function crawler(caminhoArquivo, pastaBase) {
  ...
  $('a').each((i, link) => {
    ...
    if (href && href.endsWith('.html'))  // Verifica se o link é um arquivo HTML 
    {
      let alvo = href; // Inicializa o alvo com o href do link
      if (!href.startsWith('pages/')) { // Se o href não começa com 'pages/', adiciona 'pages/' ao início do caminho
